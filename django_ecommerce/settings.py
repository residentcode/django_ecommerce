...
SECRET_KEY = 'django-insecure-j-7sd3s5nk+p)co6yft)1o=h7%$o!wd7t*xap!6p6%%o=^vq54'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'product.context_processors.product_and_category',
                'product.context_processors.get_price',
            ],
        },
    },
]
